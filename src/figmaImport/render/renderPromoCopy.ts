// Fixed, byte-identical stub — never authored per-node, never regenerated from Figma content.
// Source: user-supplied literal markup (chat, 2026-08-12), same `<!--=== PROMO-COPY ===-->`
// convention already used by this app's own advanced HTML converter output. Breakpoint-agnostic
