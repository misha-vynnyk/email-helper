...
export const REGEX_PATTERNS = {
  ...
  TABLE_SINGLE_SPAN_WRAPPER: '<table[^>]*><tr><td[^>]*>(\\s*<span[^>]*>[^<]+</span>\\s*)</td></tr></table>',
...
export const createValidationPattern = (pattern: string, flags: string = REGEX_FLAGS.GLOBAL_CASE_INSENSITIVE) => {
