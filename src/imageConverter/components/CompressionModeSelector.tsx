...
import { Compress as CompressIcon,HighQuality as QualityIcon, Speed as BalancedIcon } from '@mui/icons-material';
...
const compressionModes = [
  ...
  },
  {
    ...
    details: 'Uses advanced algorithms (mozjpeg, near-lossless). Quality automatically set to 90%+.',
  },
  {
    ...
    <Box>
      ...
      >
        {compressionModes.map((mode) => (
          <MenuItem key={mode.value} value={mode.value} disabled={mode.value === 'lossless' && !isLosslessAvailable}>
