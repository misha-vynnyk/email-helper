  ...
  return (
    <Box>
      <ToggleButtonGroup
        ...
        exclusive
        onChange={(_, value) => value && updateSettings({ processingMode: value as ProcessingMode })}
        fullWidth
      >
        <ToggleButton value="client" sx={{ borderRadius: 5 }}>
        ...
        <ToggleButton value="server" sx={{ borderRadius: 5 }}>
