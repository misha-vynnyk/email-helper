 ...
 * Advanced-конвеєр підтримує лише i-r-s/i-l-s (worksInAdvanced: true) — див.
 * advanced/preprocess.ts resolveSideImageMarkers. Решта wrapper-маркерів
 * (sign-i, ftr-s, ftr-c) залишаються worksInAdvanced: false.
 */
