import { cleanEmptyHtmlTags, isSignatureImageTag, addOneBr, replaceTripleBrWithSingle, addBrAfterClosingP, removeStylesFromLists, mergeSimilarTags, replaceAllEmojisAndSymbolsExcludingHTML } from "../htmlUtils";
