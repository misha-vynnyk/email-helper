import { FolderOpen, Image as ImageIcon, LayoutGrid, LayoutTemplate, Mail, Table, Wand2 } from "lucide-react";
...
const TAB_VALUES = ["email", "blocks", "templates", "images", "converter", "builder", "figma-import"] as const;
