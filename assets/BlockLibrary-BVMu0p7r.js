...
</html>`,Ke=e=>Ge.replace(`{{CONTENT}}`,e);function qe({children:e,width:t,onWidthChange:n,zoom:r}){let i=(0,B.useRef)(null),[a,o]=(0,B.useState)(!1),[s,c]=(0,B.useState)(typeof t==`number`?t:600);(0,B.useEffect)(()=>{typeof t==`number`&&c(t)},[t]);let l=(0,B.useCallback)(e=>{t!==`responsive`&&(e.preventDefault(),o(!0))},[t]),u=(0,B.useCallback)(e=>{if(!a||!i.current||t===`responsive`)return;let n=i.current.getBoundingClientRect(),o=n.left+n.width/2,s=Math.abs(e.clientX-o),l=Math.max(200,Math.min(2e3,s*2/r));c(Math.round(l))},[a,r,t]),d=(0,B.useCallback)(()=>{a&&t!==`responsive`&&(o(!1),n(s))},[a,s,n,t]);(0,B.useEffect)(()=>{if(a)return document.addEventListener(`mousemove`,u),document.addEventListener(`mouseup`,d),document.body.style.cursor=`ew-resize`,document.body.style.userSelect=`none`,()=>{document.removeEventListener(`mousemove`,u),document.removeEventListener(`mouseup`,d),document.body.style.cursor=``,document.body.style.userSelect=``}},[a,u,d]);let f=t===`responsive`,p=a?s:typeof t==`number`?t:600;return(0,X.jsxs)(`div`,{ref:i,className:`relative w-full`,children:[!f&&(0,X.jsx)(`div`,{className:`flex justify-center mb-2 relative`,children:(0,X.jsxs)(`div`,{className:`flex items-center justify-center text-primary font-mono text-[11px] font-semibold rounded-t border border-primary bg-primary/[0.08]`,style:{width:`${p*r}px`,height:20,transition:a?`none`:`width 0.3s ease`},children:[p,`px`]})}),(0,X.jsxs)(`div`,{className:`flex justify-center relative`,children:[!f&&(0,X.jsx)(`div`,{onMouseDown:l,className:`group absolute top-0 bottom-0 w-2 cursor-ew-resize ${a?`bg-primary`:`bg-transparent hover:bg-primary`}`,style:{left:`calc(50% - ${p*r/2}px - 4px)`,transition:a?`none`:`all 0.3s ease`},children:(0,X.jsx)(`span`,{className:`absolute top-1/2 -translate-y-1/2 rounded bg-white`,style:{left:3,width:2,height:30}})}),(0,X.jsx)(`div`,{style:{width:f?`100%`:`${p}px`,transition:a?`none`:`width 0.3s ease`},children:e}),!f&&(0,X.jsx)(`div`,{onMouseDown:l,className:`group absolute top-0 bottom-0 w-2 cursor-ew-resize ${a?`bg-primary`:`bg-transparent hover:bg-primary`}`,style:{right:`calc(50% - ${p*r/2}px - 4px)`,transition:a?`none`:`all 0.3s ease`},children:(0,X.jsx)(`span`,{className:`absolute top-1/2 -translate-y-1/2 rounded bg-white`,style:{right:3,width:2,height:30}})})]}),a&&(0,X.jsxs)(D.div,{initial:{opacity:0},animate:{opacity:1},className:`fixed top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 text-primary-foreground px-4 py-2 rounded font-mono text-sm font-semibold pointer-events-none shadow-lg`,style:{backgroundColor:`hsl(var(--primary) / 0.95)`,zIndex:1e4},children:[s,`px`]})]})}var Q=[{name:`Mobile S`,width:320,height:568,icon:(0,X.jsx)(T,{size:16})},{name:`Mobile M`,width:375,height:667,icon:(0,X.jsx)(T,{size:16})},{name:`Mobile L`,width:425,height:812,icon:(0,X.jsx)(T,{size:16})},{name:`Tablet`,width:768,height:1024,icon:(0,X.jsx)(oe,{size:16})},{name:`Laptop`,width:1024,height:768,icon:(0,X.jsx)(h,{size:16})},{name:`Desktop`,width:1440,height:900,icon:(0,X.jsx)(h,{size:16})}];function Je({width:e,onWidthChange:t,orientation:n,onOrientationChange:r}){let[i,a]=B.useState(typeof e==`number`?e:375);return(0,X.jsxs)(`div`,{className:`flex items-center gap-4`,children:[(0,X.jsxs)(`select`,{value:(()=>{if(e===`responsive`)return`responsive`;let t=Q.find(t=>(n===`portrait`?t.width:t.height)===e);return t?t.name:`custom`})(),onChange:e=>{let r=e.target.value;if(r===`responsive`)t(`responsive`);else if(r===`custom`)t(i);else{let e=Q.find(e=>e.name===r);if(e){let r=n===`portrait`?e.width:e.height;a(r),t(r)}}},className:`h-8 min-w-[150px] rounded-lg border border-input bg-background px-2 text-xs text-foreground outline-none transition-all focus:border-primary/50 focus:ring-2 focus:ring-primary/20`,children:[(0,X.jsx)(`option`,{value:`responsive`,children:`Responsive`}),Q.map(e=>(0,X.jsxs)(`option`,{value:e.name,children:[e.name,` (`,n===`portrait`?e.width:e.height,`px)`]},e.name)),(0,X.jsx)(`option`,{value:`custom`,children:`Custom`})]}),e!==`responsive`&&(0,X.jsxs)(X.Fragment,{children:[(0,X.jsxs)(`div`,{className:`relative w-[100px]`,children:[(0,X.jsx)(`input`,{type:`number`,value:i,onChange:n=>{let r=parseInt(n.target.value)||375;a(r),e!==`responsive`&&t(r)},className:`h-8 w-full rounded-lg border border-input bg-background pl-2 pr-7 text-xs text-foreground outline-none transition-all focus:border-primary/50 focus:ring-2 focus:ring-primary/20`}),(0,X.jsx)(`span`,{className:`pointer-events-none absolute right-2 top-1/2 -translate-y-1/2 text-[10px] text-muted-foreground`,children:`px`})]}),(0,X.jsx)(`button`,{onClick:()=>{let i=n===`portrait`?`landscape`:`portrait`;if(r(i),typeof e==`number`){let r=Q.find(t=>(n===`portrait`?t.width:t.height)===e);if(r){let e=i===`portrait`?r.width:r.height;a(e),t(e)}}},title:`Rotate viewport`,className:`flex items-center justify-center w-8 h-8 rounded-lg text-muted-foreground hover:bg-muted hover:text-foreground transition-colors`,children:(0,X.jsx)(b,{size:16})}),(0,X.jsx)(`span`,{className:`min-w-[60px] text-xs text-muted-foreground`,children:n===`portrait`?`Portrait`:`Landscape`})]}),e!==`responsive`&&(0,X.jsxs)(`span`,{className:`text-xs font-semibold text-primary`,children:[i,` × auto`]})]})}var Ye={primary:`border-primary/30 bg-primary/10 text-primary`,secondary:`border-purple-300 bg-purple-50 text-purple-700 dark:border-purple-800/50 dark:bg-purple-950/40 dark:text-purple-300`,warning:`border-amber-300 bg-amber-50 text-amber-700 dark:border-amber-800/50 dark:bg-amber-950/40 dark:text-amber-300`,default:`border-border bg-muted/40 text-muted-foreground`};function Xe({block:e,onDelete:t,onUpdate:n,isFileBlock:r=!1}){let a=(0,B.useMemo)(()=>Ke(e.html),[e.html]),o=(()=>{switch(e.source){case`src`:return{label:`src/blocks`,color:`secondary`,tooltip:e.filePath||`Source code blocks - requires rebuild`};case`data`:if(e.filePath){let t=e.filePath.substring(0,e.filePath.lastIndexOf(`/`)),n=t;for(let e of[`server/data/blocks/`,`data/blocks/`,`blocks/`]){let r=t.indexOf(e);if(r!==-1){n=t.substring(r);break}}let r=n.split(`/`);return r.length>3&&(n=`.../`+r.slice(-3).join(`/`)),{label:n,color:`primary`,tooltip:`Full path: ${t}`}}return{label:`data/blocks/files`,color:`primary`,tooltip:`Data blocks - immediately visible`};case`localStorage`:return{label:`Browser Storage`,color:`warning`,tooltip:`Stored in browser localStorage`};default:return{label:`Unknown`,color:`default`,tooltip:`Unknown source location`}}})(),[p,m]=(0,B.useState)(!1),[h,g]=(0,B.useState)(!1),[_,v]=(0,B.useState)(!1),[y,b]=(0,B.useState)(e.html),[x,S]=(0,B.useState)(`responsive`),[C,w]=(0,B.useState)(`portrait`),[T,D]=(0,B.useState)(null),[A,j]=(0,B.useState)(!1),[M,F]=(0,B.useState)(!1),[I,L]=(0,B.useState)(1);(0,B.useEffect)(()=>{if(!h)return;let e=e=>{e.key===`+`||e.key===`=`?(e.preventDefault(),L(e=>Math.min(3,e+.1))):e.key===`-`||e.key===`_`?(e.preventDefault(),L(e=>Math.max(.25,e-.1))):(e.key===`r`||e.key===`R`||e.key===`0`)&&(e.preventDefault(),L(1))},t=e=>{(e.ctrlKey||e.metaKey)&&(e.preventDefault(),e.deltaY<0?L(e=>Math.min(3,e+.1)):L(e=>Math.max(.25,e-.1)))};return window.addEventListener(`keydown`,e),window.addEventListener(`wheel`,t,{passive:!1}),()=>{window.removeEventListener(`keydown`,e),window.removeEventListener(`wheel`,t)}},[h]);let R=async()=>{try{await navigator.clipboard.writeText(e.html),O.success(`Code copied to clipboard!`)}catch(e){let t=e instanceof Error?e.message:`Unknown error`;i.error(`BlockItem`,`Failed to copy block HTML`,e),O.error(`Copy failed: ${t}. Check clipboard permissions.`)}};return(0,X.jsxs)(X.Fragment,{children:[(0,X.jsxs)(`div`,{className:`h-full flex flex-col bg-card rounded-2xl border border-border/50 shadow-soft hover:shadow-lg hover:border-border transition-all duration-300 group overflow-hidden`,children:[(0,X.jsxs)(`div`,{className:`relative flex items-center justify-center overflow-hidden border-b border-border/50 cursor-pointer bg-muted/30`,style:{height:Y.PREVIEW_HEIGHT},onClick:()=>g(!0),children:[e.preview?(0,X.jsx)(`img`,{src:e.preview,alt:e.name,style:{maxWidth:`100%`,maxHeight:`100%`,objectFit:`contain`}}):(0,X.jsx)(`div`,{className:`w-full h-full flex items-center justify-center text-xs text-muted-foreground p-4`,dangerouslySetInnerHTML:{__html:a}}),(0,X.jsxs)(`div`,{className:`absolute top-2 right-2 opacity-0 group-hover:opacity-100 transition-opacity duration-200 flex gap-1 bg-black/70 rounded-lg p-1 backdrop-blur-sm`,onClick:e=>e.stopPropagation(),children:[(0,X.jsx)(`button`,{onClick:R,className:`p-1.5 text-white hover:bg-white/20 rounded-md transition-colors`,title:`Quick copy`,children:(0,X.jsx)(l,{size:14})}),(0,X.jsx)(`button`,{onClick:()=>g(!0),className:`p-1.5 text-white hover:bg-white/20 rounded-md transition-colors`,title:`Full preview`,children:(0,X.jsx)(k,{size:14})})]})]}),(0,X.jsxs)(`div`,{className:`flex-grow p-4`,children:[(0,X.jsxs)(`div`,{className:`flex justify-between items-start mb-2 gap-2`,children:[(0,X.jsx)(`h3`,{className:`text-base font-bold text-foreground leading-tight`,children:e.name}),(e.isCustom||r)&&(0,X.jsx)(`span`,{className:`shrink-0 px-2 py-0.5 rounded-full text-[10px] font-bold bg-primary/10 text-primary`,children:r?`File`:`Custom`})]}),(0,X.jsxs)(`div`,{className:`flex flex-wrap items-center gap-1.5 mb-2`,children:[(0,X.jsxs)(`span`,{className:`inline-flex items-center gap-1 px-2 py-0.5 rounded-full text-[10px] font-semibold bg-muted text-foreground border border-border/50`,children:[We(e.category),e.category]}),(0,X.jsxs)(`span`,{title:o.tooltip,className:E(`inline-flex items-center gap-1 px-2 py-0.5 rounded-full text-[10px] font-semibold border`,Ye[o.color]),children:[(0,X.jsx)(d,{size:12}),o.label]})]}),(0,X.jsxs)(`p`,{className:`text-xs text-muted-foreground`,children:[e.keywords.slice(0,Y.MAX_KEYWORDS_DISPLAY).join(`, `),e.keywords.length>Y.MAX_KEYWORDS_DISPLAY&&`...`]})]}),(0,X.jsxs)(`div`,{className:`flex items-center justify-between px-4 pb-4`,children:[(0,X.jsxs)(`div`,{className:`flex items-center gap-1`,children:[(0,X.jsx)(`button`,{onClick:()=>{b(e.html),v(!1),m(!0)},title:`View code`,className:`p-2 text-muted-foreground hover:bg-muted hover:text-foreground rounded-lg transition-colors`,children:(0,X.jsx)(s,{size:16})}),(0,X.jsx)(`button`,{onClick:()=>g(!0),title:`Preview`,className:`p-2 text-muted-foreground hover:bg-muted hover:text-foreground rounded-lg transition-colors`,children:(0,X.jsx)(k,{size:16})})]}),(0,X.jsxs)(`div`,{className:`flex items-center gap-1`,children:[(0,X.jsxs)(`button`,{onClick:R,className:`flex items-center gap-1.5 px-3 py-1.5 text-xs font-semibold text-muted-foreground hover:bg-muted hover:text-foreground rounded-lg transition-colors`,children:[(0,X.jsx)(l,{size:14}),` Copy`]}),t&&(0,X.jsx)(`button`,{onClick:()=>{F(!0)},disabled:A,title:`Delete`,className:`p-2 text-destructive hover:bg-destructive/10 rounded-lg transition-colors disabled:opacity-50`,children:(0,X.jsx)(ee,{size:16})})]})]})]}),(0,X.jsxs)(N,{open:p,onClose:()=>m(!1),maxWidthClass:`max-w-2xl`,title:`HTML Code - ${e.name}`,headerExtra:(e.isCustom||r)&&!_?(0,X.jsxs)(`button`,{onClick:()=>{v(!0)},className:`flex items-center gap-1.5 px-3 py-1.5 text-xs font-bold border border-border rounded-lg hover:bg-muted transition-colors`,children:[(0,X.jsx)(P,{size:14}),` Edit`]}):void 0,actionsRow:_?(0,X.jsxs)(X.Fragment,{children:[(0,X.jsx)(`button`,{onClick:()=>{b(e.html),v(!1)},className:`px-5 py-2.5 text-sm font-bold bg-muted hover:bg-muted/80 text-foreground rounded-xl transition-all`,children:`Cancel`}),(0,X.jsx)(`button`,{onClick:async()=>{if(!y.trim()){D(`HTML code cannot be empty`);return}try{if(r){let t=await V.updateBlock(e.id,{html:y.trim()});t&&n&&(n({...e,html:t.html}),O.success(`Block updated successfully!`),v(!1),m(!1))}else{let t=je(e.id,{html:y.trim()});t&&n?(n(t),O.success(`Block updated successfully!`),v(!1),m(!1)):D(`Failed to update block`)}}catch(e){let t=e instanceof Error?e.message:`Unknown error`;i.error(`BlockItem`,`Failed to save block`,e),t.includes(`network`)||t.includes(`fetch`)?D(`Network error. Check your connection.`):D(r?`File update failed: ${t}`:`Save failed: ${t}`)}},disabled:!y.trim(),className:`px-5 py-2.5 text-sm font-bold bg-primary hover:brightness-110 text-primary-foreground rounded-xl transition-all shadow-sm disabled:opacity-50`,children:`Save Changes`})]}):(0,X.jsxs)(X.Fragment,{children:[(0,X.jsxs)(`button`,{onClick:R,className:`px-5 py-2.5 flex items-center gap-2 text-sm font-bold bg-muted hover:bg-muted/80 text-foreground rounded-xl transition-all`,children:[(0,X.jsx)(l,{size:16}),` Copy to Clipboard`]}),(0,X.jsx)(`button`,{onClick:()=>m(!1),className:`px-5 py-2.5 text-sm font-bold bg-primary hover:brightness-110 text-primary-foreground rounded-xl transition-all shadow-sm`,children:`Close`})]}),children:[T&&(0,X.jsx)(`div`,{className:`mb-4 rounded-xl border border-red-200 bg-red-50 text-red-800 dark:border-red-800/50 dark:bg-red-950/40 dark:text-red-200 px-3.5 py-2.5 text-xs leading-relaxed`,children:T}),(0,X.jsx)(`textarea`,{rows:15,readOnly:!_,value:_?y:e.html,onChange:_?e=>b(e.target.value):void 0,placeholder:_?`Enter your email-safe HTML code here...`:void 0,className:E(`w-full font-mono text-sm rounded-xl border border-input p-3 text-foreground outline-none resize-y`,_?`bg-background focus:border-primary/50 focus:ring-2 focus:ring-primary/20`:`bg-muted/30 cursor-default`)})]}),(0,X.jsx)(N,{open:h,onClose:()=>{g(!1),L(1)},maxWidthClass:`max-w-5xl`,title:`${e.name} - Preview`,actionsRow:(0,X.jsxs)(`div`,{className:`flex items-center justify-between w-full gap-3`,children:[(0,X.jsxs)(`p`,{className:`text-xs text-muted-foreground`,children:[`💡 Tip: Use `,(0,X.jsx)(`strong`,{className:`text-foreground`,children:`+/-`}),` keys,`,` `,(0,X.jsx)(`strong`,{className:`text-foreground`,children:`R`}),` to reset, or`,` `,(0,X.jsx)(`strong`,{className:`text-foreground`,children:`Ctrl+Scroll`}),` to zoom`]}),(0,X.jsx)(`button`,{onClick:()=>g(!1),className:`px-5 py-2.5 text-sm font-bold bg-primary hover:brightness-110 text-primary-foreground rounded-xl transition-all shadow-sm shrink-0`,children:`Close`})]}),children:(0,X.jsxs)(`div`,{className:`flex flex-col gap-3`,children:[(0,X.jsxs)(`div`,{className:`flex items-center justify-between flex-wrap gap-3`,children:[(0,X.jsxs)(`div`,{className:`flex items-center rounded-lg border border-border overflow-hidden`,children:[(0,X.jsx)(`button`,{onClick:()=>L(e=>Math.max(.25,e-.1)),disabled:I<=.25,title:`Zoom out (-)`,className:`p-2 text-foreground hover:bg-muted transition-colors disabled:opacity-40`,children:(0,X.jsx)(c,{size:14})}),(0,X.jsx)(`button`,{onClick:()=>L(1),disabled:I===1,title:`Reset zoom (R)`,className:`p-2 text-foreground hover:bg-muted transition-colors disabled:opacity-40 border-x border-border`,children:(0,X.jsx)(f,{size:14})}),(0,X.jsxs)(`span`,{className:`px-3 text-xs font-semibold min-w-[56px] text-center`,children:[Math.round(I*100),`%`]}),(0,X.jsx)(`button`,{onClick:()=>L(e=>Math.min(3,e+.1)),disabled:I>=3,title:`Zoom in (+)`,className:`p-2 text-foreground hover:bg-muted transition-colors disabled:opacity-40 border-l border-border`,children:(0,X.jsx)(u,{size:14})})]}),(0,X.jsx)(Je,{width:x,onWidthChange:S,orientation:C,onOrientationChange:w})]}),(0,X.jsx)(`div`,{className:`overflow-auto rounded-xl p-4`,style:{maxHeight:`70vh`,backgroundColor:`#f5f5f5`},children:(0,X.jsx)(qe,{width:x,onWidthChange:S,zoom:I,children:(0,X.jsx)(`div`,{style:{transform:`scale(${I})`,transformOrigin:`top center`,transition:`transform 0.3s ease`,backgroundColor:`#fff`,minHeight:200},className:`border border-border rounded-lg p-4 shadow-md`,dangerouslySetInnerHTML:{__html:a}})})})]})}),(0,X.jsxs)(N,{open:M,onClose:()=>F(!1),maxWidthClass:`max-w-xs`,title:`Delete Block?`,actionsRow:(0,X.jsxs)(X.Fragment,{children:[(0,X.jsx)(`button`,{onClick:()=>F(!1),className:`px-5 py-2.5 text-sm font-bold bg-muted hover:bg-muted/80 text-foreground rounded-xl transition-all`,children:`Cancel`}),(0,X.jsx)(`button`,{onClick:async()=>{if(t)try{j(!0),F(!1),t(e.id),O.success(`"${e.name}" deleted successfully`)}catch(e){let t=e instanceof Error?e.message:`Unknown error`;i.error(`BlockItem`,`Failed to delete block`,e),O.error(`Delete failed: ${t}`)}finally{j(!1)}},disabled:A,className:`px-5 py-2.5 text-sm font-bold bg-destructive hover:brightness-110 text-destructive-foreground rounded-xl transition-all shadow-sm disabled:opacity-50`,children:`Delete`})]}),children:[(0,X.jsxs)(`p`,{className:`text-foreground`,children:[`Are you sure you want to delete `,(0,X.jsxs)(`strong`,{children:[`"`,e.name,`"`]}),`?`]}),(0,X.jsx)(`p`,{className:`text-sm text-muted-foreground mt-1`,children:r?`This will permanently delete the .ts file from your project.`:`This action cannot be undone.`})]})]})}var Ze=B.memo(Xe,(e,t)=>e.block.id===t.block.id&&e.block.name===t.block.name&&e.block.html===t.block.html&&e.isFileBlock===t.isFileBlock),$=16,Qe=Y.PREVIEW_HEIGHT+180,$e=Qe+$;function et(e){let[t,n]=(0,B.useState)(()=>typeof window<`u`?window.matchMedia(e).matches:!1);return(0,B.useEffect)(()=>{if(typeof window>`u`)return;let t=window.matchMedia(e),r=()=>n(t.matches);return r(),t.addEventListener(`change`,r),()=>t.removeEventListener(`change`,r)},[e]),t}function tt({index:e,style:t,blocks:n,columns:r,fileBlockIds:i,onDelete:a,onUpdate:o}){let s=e*r,c=n.slice(s,s+r);return(0,X.jsx)(`div`,{style:{...t,height:Qe,paddingLeft:16,paddingRight:16,boxSizing:`border-box`,display:`grid`,gridTemplateColumns:`repeat(${r}, 1fr)`,gap:`${$}px`},children:c.map(e=>(0,X.jsx)(Ze,{block:e,onDelete:a,onUpdate:o,isFileBlock:i.has(e.id)},`${e.source||`unknown`}-${e.id}`))})}function nt({blocks:e,fileBlocks:t,onDelete:n,onUpdate:r}){let i=et(`(max-width: 599.98px)`),a=et(`(min-width: 600px) and (max-width: 899.98px)`),o=i?1:a?2:3,s=Math.ceil(e.length/o),c=(0,B.useMemo)(()=>new Set(t.map(e=>e.id)),[t]),l=(0,B.useMemo)(()=>({blocks:e,columns:o,fileBlockIds:c,onDelete:n,onUpdate:r}),[e,o,c,n,r]),[u,d]=C();return e.length===0?null:(0,X.jsx)(`div`,{ref:u,className:`w-full h-full`,style:{paddingTop:`${$}px`},children:d.width>0&&d.height>0&&(0,X.jsx)(y,{rowComponent:tt,rowCount:s,rowHeight:$e,rowProps:l,overscanCount:2,style:{height:d.height-$,width:d.width}})})}var rt=`h-11 w-full rounded-xl border border-input bg-background px-3 text-sm text-foreground outline-none transition-all focus:border-primary/50 focus:ring-2 focus:ring-primary/20 appearance-none cursor-pointer`;function it(){let[e,t]=(0,B.useState)([]),[n,r]=(0,B.useState)([]),[a,o]=(0,B.useState)([]),[s,c]=(0,B.useState)(``),[l,d]=(0,B.useState)(`All`),[f,p]=(0,B.useState)(`all`),[m,h]=(0,B.useState)(!0),[v,y]=(0,B.useState)(!1),[b,x]=(0,B.useState)(null),[C,T]=(0,B.useState)(!1),[E,D]=(0,B.useState)(!1),O=te(s,ze.DEBOUNCE_SEARCH),k=e=>e.includes(`/src/blocks`)?`src`:`data`,A=(0,B.useCallback)(async()=>{try{return(await V.listBlocks()).filter(e=>e.filePath).map(e=>({id:e.id,name:e.name,category:e.category,keywords:e.keywords,html:e.html,preview:e.preview,createdAt:e.createdAt||Date.now(),isCustom:!0,source:k(e.filePath),filePath:e.filePath}))}catch(e){return i.warn(`BlockLibrary`,`File API unavailable`,e),[]}},[]);(0,B.useEffect)(()=>{(async()=>{try{h(!0),x(null);let e=q(!1),[n,a,s]=await Promise.all([ke(),Promise.resolve(W()),A()]);if(t(n),o(a.map(e=>({...e,source:`localStorage`}))),e.length===0)r([]);else{let t=new Set(e.map(e=>e.path)),n=s.filter(e=>e.filePath?Array.from(t).some(t=>e.filePath.includes(t)):!1);r(n)}ce([...n,...a.map(e=>({...e,source:`localStorage`})),...s]).catch(e=>{i.warn(`BlockLibrary`,`Failed to preload block images`,e)})}catch(e){let t=e instanceof Error?e.message:`Unknown error`;i.error(`BlockLibrary`,`Failed to load blocks`,e),x(`Failed to load blocks: ${t}`)}finally{h(!1)}})()},[A,E]);let j=(0,B.useMemo)(()=>{switch(f){case`src`:return e;case`data`:return n;case`localStorage`:return a;default:return[...e,...n,...a]}},[f,e,n,a]),N=(0,B.useMemo)(()=>Ne(j,O,l===`All`?void 0:l),[j,O,l]),P=(0,B.useMemo)(()=>Pe(j),[j]),F=(0,B.useCallback)(async s=>{if(!v){y(!0);try{if(n.find(e=>e.id===s)){try{await V.deleteBlock(s);let e=await A(),t=q(!1);if(t.length===0)r(e);else{let n=new Set(t.map(e=>e.path)),i=e.filter(e=>e.filePath?Array.from(n).some(t=>e.filePath.includes(t)):!1);r(i)}}catch(e){i.error(`BlockLibrary`,`Failed to delete file block`,e),x(U(e))}return}if(a.find(e=>e.id===s)){Me(s),o(W().map(e=>({...e,source:`localStorage`})));return}t(e.filter(e=>e.id!==s))}finally{y(!1)}}},[v,n,a,e,A]),I=(0,B.useCallback)(async e=>{if(!v){y(!0);try{if(n.find(t=>t.id===e.id)){try{await V.updateBlock(e.id,{name:e.name,category:e.category,keywords:e.keywords,html:e.html,preview:e.preview});let t=await A(),n=q(!1);if(n.length===0)r(t);else{let e=new Set(n.map(e=>e.path)),i=t.filter(t=>t.filePath?Array.from(e).some(e=>t.filePath.includes(e)):!1);r(i)}}catch(e){i.error(`BlockLibrary`,`Failed to update file block`,e),x(U(e))}return}if(a.find(t=>t.id===e.id)){let t=a.map(t=>t.id===e.id?{...e,source:`localStorage`}:t);try{G(t),o(t)}catch(e){i.error(`BlockLibrary`,`Failed to save custom block`,e),x(U(e))}return}let t={...e,isCustom:!0,source:`localStorage`},s=[...a,t];try{G(s),o(s)}catch(e){i.error(`BlockLibrary`,`Failed to save custom block`,e),x(U(e))}}finally{y(!1)}}},[v,n,a,A]),L=(0,B.useCallback)(async()=>{T(!1);let e=q(!1),[t,n]=await Promise.all([A(),Promise.resolve(W())]);if(e.length===0)r(t);else{let n=new Set(e.map(e=>e.path)),i=t.filter(e=>e.filePath?Array.from(n).some(t=>e.filePath.includes(t)):!1);r(i)}o(n.map(e=>({...e,source:`localStorage`})))},[A]);return m?(0,X.jsxs)(`div`,{className:`p-6`,children:[(0,X.jsx)(`h1`,{className:`text-2xl font-bold text-foreground mb-6`,children:`Block Library`}),(0,X.jsx)(`div`,{className:`grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 gap-4`,children:[...Array(Y.SKELETON_COUNT)].map((e,t)=>(0,X.jsxs)(`div`,{className:`bg-card border border-border/50 rounded-2xl shadow-soft p-4`,children:[(0,X.jsx)(`div`,{className:`animate-pulse bg-muted rounded-xl`,style:{height:200}}),(0,X.jsx)(`div`,{className:`animate-pulse bg-muted rounded-md h-4 mt-3 w-full`}),(0,X.jsx)(`div`,{className:`animate-pulse bg-muted rounded-md h-4 mt-2 w-3/5`})]},t))})]}):b?(0,X.jsx)(`div`,{className:`p-6`,children:(0,X.jsx)(g,{tone:`error`,children:b})}):(0,X.jsxs)(`div`,{"data-app-scroll":`true`,className:`flex flex-col h-full`,style:{overflow:N.length===0?`auto`:`hidden`},children:[(0,X.jsxs)(`div`,{className:`px-6 pt-6`,children:[(0,X.jsxs)(`div`,{className:`flex items-center justify-between mb-6 flex-wrap gap-3`,children:[(0,X.jsxs)(`div`,{children:[(0,X.jsx)(`h1`,{className:`text-2xl font-bold text-foreground`,children:`Block Library`}),(0,X.jsxs)(`p`,{className:`text-xs text-muted-foreground mt-0.5`,children:[`📁 `,e.length+n.length+a.length,` blocks in library`]})]}),(0,X.jsxs)(`div`,{className:`flex items-center gap-2`,children:[(0,X.jsxs)(`button`,{onClick:async()=>{h(!0);try{let[e,n,i]=await Promise.all([Promise.resolve(ke()),A(),Promise.resolve(W())]);t(e);let a=q(!1);if(a.length===0)r(n);else{let e=new Set(a.map(e=>e.path)),t=n.filter(t=>t.filePath?Array.from(e).some(e=>t.filePath.includes(e)):!1);r(t)}o(i.map(e=>({...e,source:`localStorage`}))),x(null)}catch(e){x(U(e))}finally{h(!1)}},disabled:m||v,className:`flex items-center gap-1.5 px-3 py-2 text-sm font-semibold border border-input text-foreground hover:bg-muted rounded-xl transition-all disabled:opacity-50`,children:[(0,X.jsx)(S,{size:16}),` Refresh`]}),(0,X.jsxs)(`button`,{onClick:()=>D(!0),className:`flex items-center gap-1.5 px-3 py-2 text-sm font-semibold border border-input text-foreground hover:bg-muted rounded-xl transition-all`,children:[(0,X.jsx)(M,{size:16}),` Storage`]}),(0,X.jsxs)(`button`,{onClick:()=>T(!0),className:`flex items-center gap-1.5 px-3 py-2 text-sm font-bold bg-primary hover:brightness-110 text-primary-foreground rounded-xl transition-all shadow-sm`,children:[(0,X.jsx)(u,{size:16}),` Add Block`]})]})]}),(0,X.jsx)(`div`,{className:`bg-card border border-border/50 rounded-2xl shadow-soft p-4 mb-6`,children:(0,X.jsxs)(`div`,{className:`grid grid-cols-1 md:grid-cols-12 gap-3 items-center`,children:[(0,X.jsxs)(`div`,{className:`md:col-span-4 relative`,children:[(0,X.jsx)(w,{size:16,className:`absolute left-3 top-1/2 -translate-y-1/2 text-muted-foreground pointer-events-none`}),(0,X.jsx)(`input`,{type:`text`,placeholder:`Search blocks...`,value:s,onChange:e=>c(e.target.value),className:`h-11 w-full rounded-xl border border-input bg-background pl-9 pr-3 text-sm text-foreground placeholder:text-muted-foreground/60 outline-none transition-all focus:border-primary/50 focus:ring-2 focus:ring-primary/20`})]}),(0,X.jsx)(`div`,{className:`md:col-span-3`,children:(0,X.jsxs)(`select`,{value:f,onChange:e=>p(e.target.value),className:rt,children:[(0,X.jsxs)(`option`,{value:`all`,children:[`🌐 All Sources (`,e.length+n.length+a.length,`)`]}),(0,X.jsxs)(`option`,{value:`src`,children:[`📁 src/blocks/ (`,e.length,`)`]}),(0,X.jsxs)(`option`,{value:`data`,children:[`💾 data/blocks/files/ (`,n.length,`)`]}),(0,X.jsxs)(`option`,{value:`localStorage`,children:[`🔒 localStorage (`,a.length,`)`]})]})}),(0,X.jsx)(`div`,{className:`md:col-span-3`,children:(0,X.jsxs)(`select`,{value:l,onChange:e=>d(e.target.value),className:rt,children:[(0,X.jsx)(`option`,{value:`All`,children:`All Categories`}),P.map(e=>(0,X.jsx)(`option`,{value:e,children:e},e))]})}),(0,X.jsx)(`div`,{className:`md:col-span-2`,children:(0,X.jsxs)(`p`,{className:`text-sm text-muted-foreground text-center`,children:[N.length,` `,N.length===1?`block`:`blocks`]})})]})})]}),N.length===0?(0,X.jsxs)(`div`,{className:`flex flex-col items-center justify-center text-center p-6`,style:{minHeight:400},children:[q(!1).length===0&&!s&&l===`All`?(0,X.jsxs)(X.Fragment,{children:[(0,X.jsx)(`div`,{className:`mb-6 max-w-[600px]`,children:(0,X.jsxs)(g,{tone:`info`,children:[(0,X.jsx)(`p`,{className:`font-bold mb-1`,children:`No visible storage locations configured!`}),(0,X.jsxs)(`p`,{children:[`Please click the `,(0,X.jsx)(`strong`,{children:`Storage`}),` button above to add locations where your blocks will be stored. For example:`,` `,(0,X.jsx)(`code`,{className:`bg-muted px-1 py-0.5 rounded`,children:`/Users/your-name/Documents/blocks`})]})]})}),(0,X.jsx)(`div`,{className:`w-[120px] h-[120px] rounded-full bg-muted flex items-center justify-center mb-4`,children:(0,X.jsx)(M,{size:60,className:`text-muted-foreground/50`})})]}):(0,X.jsxs)(X.Fragment,{children:[(0,X.jsx)(`div`,{className:`w-[120px] h-[120px] rounded-full bg-muted flex items-center justify-center mb-4`,children:s||l!==`All`?(0,X.jsx)(_,{size:60,className:`text-muted-foreground/50`}):(0,X.jsx)(u,{size:60,className:`text-muted-foreground/50`})}),(0,X.jsx)(`h2`,{className:`text-xl font-bold text-foreground mb-2`,children:s||l!==`All`?`No blocks found`:`Your block library is empty`})]}),(0,X.jsx)(`p`,{className:`text-sm text-muted-foreground mb-6 max-w-[400px]`,children:s||l!==`All`?`Try different keywords or clear filters to see more blocks.`:`Start building your email templates by creating your first custom block.`}),s||l!==`All`?(0,X.jsx)(`button`,{onClick:()=>{c(``),d(`All`)},className:`px-5 py-2.5 text-sm font-bold border border-input text-foreground hover:bg-muted rounded-xl transition-all`,children:`Clear Filters`}):(0,X.jsxs)(`button`,{onClick:()=>T(!0),className:`flex items-center gap-2 px-5 py-3 text-sm font-bold bg-primary hover:brightness-110 text-primary-foreground rounded-xl transition-all shadow-sm`,children:[(0,X.jsx)(u,{size:18}),` Create First Block`]})]}):(0,X.jsx)(`div`,{className:`flex-1 px-6 pb-6`,style:{minHeight:400},children:(0,X.jsx)(nt,{blocks:N,fileBlocks:n,onDelete:F,onUpdate:I})}),(0,X.jsx)(Ve,{open:C,onClose:()=>T(!1),onBlockAdded:L}),(0,X.jsx)(He,{open:E,onClose:()=>D(!1)})]})}export{it as default};