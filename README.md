...
Потрібно: Node.js 18+, npm. Ollama для AI-аналізу зображень (бажано, але не обовʼязково). Браузер Brave для automation/upload (локально), або ж можна використати десктопну версію з вбудованим вікном браузера.
